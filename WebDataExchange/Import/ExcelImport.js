...
$('#xxxx').dialog({
    ...
    buttons: [{
        ...
        handler: function () {
            ...
            formData.append("ifSave", ifSave.options[index].value);
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (data.status == "success") {
                        $.messager.alert("提示", "上传成功<br/>名称为" + data.name + "<br/>");
                    } else {
                        $.messager.alert("提示", "上传失败<br/>原因为" + data.data);
                    }
                },
